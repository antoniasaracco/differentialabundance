...
- [[#676]](https://github.com/nf-core/differentialabundance/pull/676) - unification parameters lfc, pval, qval for differential expression analysis methods. ([@antoniasaracco](https://github.com/antoniasaracco), review by [@grst](https://github.com/grst) and [@pinin4fjords](https://github.com/pinin4fjords)).
